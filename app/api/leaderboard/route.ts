...
// Simulated leaderboard data (same as in the page component)
const players = [
  {
    rank: 18,
    name: 'MAYA KIM',
...
export async function GET(request: Request) {
  try {
    ...
    // Simulate async operation (remove for real API)
    ...
    const response: LeaderboardResponse = {
      ...
      currentUser: cursor === 0 ? currentUser : null, // Only return current user on first load
      hasNextPage,
      nextCursor,
